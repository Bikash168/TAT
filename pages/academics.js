      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col lg:flex-row gap-8 mt-[1 px] sm:mt-[2.5px] lg:mt-[5px] mb-16">
        ...
        <div className="w-full lg:w-3/4 space-y-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              <h2 class="text-xl font-semibold mb-4">Academic Advisory Board</h2>
              <p class="text-lg text-justify">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              <h2 class="text-xl font-semibold mb-4">Academic Monitoring Council</h2>
              <p class="text-lg text-justify">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              <h2 class="text-xl font-semibold mb-4">Peer Evaluation</h2>
              <p class="text-lg text-justify">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              <h2 class="text-xl font-semibold mb-4">Programme & Course Outcome</h2>
              <p class="text-lg text-justify">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              <h2 class="text-xl font-semibold mb-4">Time Table</h2>
              <p class="text-lg text-justify">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
              <h2 class="text-xl font-semibold mb-4">BPUT Regulation</h2>
              <p class="text-lg text-justify">
