...
export default function About() {
  return (
    ...
    <main className="container mx-auto px-4 lg:px-16 py-2 pt-20">
      {/* About Section */}
        ...
        <section className="bg-white p-6 sm:p-8 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-lg transition-transform hover:scale-105 hover:shadow-2xl">
