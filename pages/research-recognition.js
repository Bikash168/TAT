    ...
    return (
        <Layout title="Research Recognition | Trident Academy of Technology">
            ...
            <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* SIRO Recognized Section */}
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h2 className="text-xl sm:text-2xl font-bold mb-4">SIRO Recognized</h2>
                    <p className="text-base sm:text-lg mb-4 leading-relaxed">
                        The Scientific and Industrial Research Organizations (SIROs), which are part of the Department
                        of Scientific and Industrial Research (DSIR), Ministry of Science and Technology, Government of
                        India, have recognized the Trident Group of Institutions in Bhubaneswar. Its main goal is to
                        unite non-profit organizations that operate on a volunteer basis in order to support their
                        initiatives in the fields of scientific and industrial research, design, and development of
                        homegrown technology in order to achieve technological self-reliance and reduce the use of
                        foreign inputs.
                    </p>
                    <p className="text-base sm:text-lg mb-4 leading-relaxed">
                        The Trident Group was able to build in-house research and development on new technologies,
                        products, processes, designs, quality, ranges, etc., thanks to this important accreditation.
                        Additionally, it makes it possible for us to obtain financial Research and Development grants
                        from numerous funding organizations, including DST, CSIR, DBT, TDB, ICMR, and ICAR.
                    </p>
                    <a
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p className="text-base sm:text-lg mb-4 leading-relaxed">
                        Trident has been recognized to be the Nodal Centre for Research by Biju Patnaik University of
                        Technology for two Departments:
                    </p>
