    ...
    return (
        <Layout title="Electronics Engineering (VLSI Design Technology) | Trident Academy of Technology">
            ...
            >
                ...
                <h1 className="rrelative text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold text-white z-10 text-center px-4 mt-16 sm:mt-0">
                ...
                <aside className="lg:w-1/4 w-full bg-[#002147] text-white p-4 rounded-lg shadow-md">
                    ...
                    <div className={`lg:block ${isSidebarOpen ? 'block' : 'hidden'} lg:w-full`}>
                        <ul className="space-y-3">
                            {[
                                { name: 'Overview', link: '/overview-electronics-vlsi' },
                                { name: 'Courses', link: '#courses' },
                                { name: 'Research', link: '#research' },
                                { name: 'Career Prospects', link: '#careers' },
                            ].map((item) => (
                                <li key={item.name}>
                                    <Link href={item.link}>
